  ...
  <aside class="flex min-h-0 flex-col overflow-hidden rounded-lg border border-slate-700 bg-slate-900/40">
    <div class="flex-1 space-y-4 overflow-y-auto p-3">
      ...
      <section class="space-y-2">
        <h2 class="px-1 text-xs uppercase tracking-wider text-slate-500">{{ t('execute.connection') }}</h2>
      ...
      <section v-if="status.connected" class="space-y-2">
        <h2 class="px-1 text-xs uppercase tracking-wider text-slate-500">{{ t('execute.jog') }}</h2>
      ...
      <!-- SEND / QUEUE -->
      <section class="space-y-2">
        <h2 class="px-1 text-xs uppercase tracking-wider text-slate-500">{{ t('execute.run') }}</h2>
      ...
      <section v-if="queue.runs.length" class="space-y-2">
        <h2 class="px-1 text-xs uppercase tracking-wider text-slate-500">
          {{ t('queue.title') }}
