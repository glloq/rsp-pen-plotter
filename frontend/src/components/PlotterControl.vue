...
<template>
  <div class="flex h-full min-h-0 flex-col gap-2">
    <div
      class="flex min-h-0 flex-1 overflow-hidden rounded-lg border border-slate-700 bg-slate-900"
    >
      <!-- SIDEBAR -->
          ...
          <template v-else>
            ...
            <section class="space-y-2">
              ...
              <div class="rounded-lg border border-slate-700 bg-slate-800 p-3">
                ...
                <p
                  v-if="
                    !job.selectedProfile?.pen_up_command || !job.selectedProfile?.pen_down_command
                  "
