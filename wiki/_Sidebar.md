...
- [Vectors (SVG, PDF, EPS, DXF)](File-Type-Vectors.md)
- [Documents (DOCX, ODT, HTML)](File-Type-Documents.md)
...
### Troubleshooting
- [Installer](Troubleshooting-Install.md)
- [Connection](Troubleshooting-Connection.md)
- [Plot quality](Troubleshooting-Quality.md)
