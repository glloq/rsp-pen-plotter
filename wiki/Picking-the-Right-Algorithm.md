...
OmniPlot ships 27+ raster algorithms. This page is a decision tree, not a
catalogue — for the full algorithm table see
...
| Topographic map / contour | Iso-lines | `contours` |
| Abstract poster | Generative pattern | `truchet`, `brick`, `rings`, `sunburst`, `circle_pack` |
| Anything | One unbroken stroke | `tsp_opt`, `hilbert`, `gosper`, `spiral` |
