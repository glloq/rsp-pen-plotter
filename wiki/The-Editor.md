...
segmentation too). All 171 styles live in one registry,
`frontend/src/data/printRegistry.ts`, split by **scope**:

- **Master styles** (`scope: 'master'`, 120 entries) own the whole result:
  ...
  - 69 **tonal (monochrome)** masters — Pencil, Halftone shaded,
